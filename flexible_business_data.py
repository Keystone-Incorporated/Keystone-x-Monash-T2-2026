...
FILES = [
    ...
    ("Retail.csv", "Retail"),
    ("Hospitality_Melb_ALL.csv", "Hospitality")
    # Add more here, e.g.:
...
def process_file(filepath, industry, scrape_emails=False):
    ...
    for col in ['Wheelchair-Accessible Entrance', 'Wheelchair-Accessible Car Park', 'Auracast Broadcast Audio', 'Assisted Listening Devices', 'Wheelchair-Accessible Seating', 'Wheelchair-Accessible Toilet']:
...
if __name__ == "__main__":
    ...
    for filepath, industry in FILES:
        df = process_file(filepath, industry, scrape_emails=True)
        processed.append(df)
